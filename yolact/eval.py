...
def evaluate(net:Yolact, dataset, train_mode=False):
    ...
    # print(f"printing dataset indices {dataset_indices}")
    # print(f"printing len of dataset indices {len(dataset_indices)}")
    ...
    #print(f"printing dataset indices concatenated {dataset_indices}")
    ...
    try:
        ...
        for it, image_idx in enumerate(dataset_indices):
            ...
            #print(f"printing image idx {image_idx}")
            #print(f"printing dataset.ids[image_idx] {dataset.ids[image_idx]}")
