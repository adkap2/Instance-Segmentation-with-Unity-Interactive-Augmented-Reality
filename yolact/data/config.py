...
SYNTHETIC_CLASSES = ('Bed', 'Chair_Arm', 'Dresser', 'Nightstand', 'Sofa', 'Table_Dining')
...
grocery_dataset = dataset_base.copy({
    'name': 'Grocery',

    'train_images': './data/output_path/coco/images/',
    'train_info':   './data/output_path/coco/instances.json',

    'valid_images': './data/output_path/coco/images/',
    'valid_info':   './data/output_path/coco/instances.json',

    # 'valid_images': './data/grocery/images/val/',
    # 'valid_info':   './data/grocery/annotations/val.json',
...
SyntheticHome = dataset_base.copy({
    ...
    # 'train_images': './data/Synthetic_Home/train_data_output/coco/images/',
    # 'train_info':   './data/Synthetic_Home/train_data_output/coco/instances.json',

    # # 'valid_images': './data/Synthetic_Home/val_data_output/coco/images/',
    # # 'valid_info':   './data/Synthetic_Home/val_data_output/coco/instances.json',
    # 'valid_images': './data/Synthetic_Home/train_data_output/coco/images/',
    # 'valid_info':   './data/Synthetic_Home/train_data_output/coco/instances.json',

    #'train_images': './data/Synthetic_Home/train/data/',
    #'train_info':   './data/Synthetic_Home/train/labels.json',

    #'valid_images': './data/Synthetic_Home/val/data/',
    #'valid_info':   './data/Synthetic_Home/val/labels.json',
    ...
    # 'train_images': './data/Synthetic_Home/coco_one/data/',
    # 'train_info':   './data/Synthetic_Home/coco_one/labels.json',

    # 'valid_images': './data/Synthetic_Home/coco_one/data/',
    # 'valid_info':   './data/Synthetic_Home/coco_one/labels.json',
...
coco_test_2017_dataset = dataset_base.copy({
    'name': 'COCO_Test_2017',

    'train_images': './data/coco/coco_test/train/data',
    'train_info': './data/coco/coco_test/train/labels.json',

    'valid_images': './data/coco/coco_test/val/data',
    'valid_info': './data/coco/coco_test/val/labels.json',
...
my_indoor_env_dataset = dataset_base.copy({
    'name': 'My Indoor Environment',

    'train_images': './data/coco/Indoor_Env_Images',
    'valid_images': './data/coco/Indoor_Env_Images',
    
    'train_info': './data/coco/Indoor_Env_Annotations/Indoor_Env.json',
    'valid_info': './data/coco/Indoor_Env_Annotations/Indoor_Env.json',

    'has_gt': True,

    'class_names': ('door', 'window', 'table', 'couch', 'chair', 'doorway'),
