...
SyntheticHome = dataset_base.copy({
    'name': 'SyntheticHome',
    'train_images': '../../../../../../media/adam/WinStorage/SyntheticHomes/train_2/data/',
    'train_info':   '../../../../../../media/adam/WinStorage/SyntheticHomes/train_2/labels.json',
    'valid_images': '../../../../../../media/adam/WinStorage/SyntheticHomes/val_2/data/',
    'valid_info':   '../../../../../../media/adam/WinStorage/SyntheticHomes/val_2/labels.json',
    ...
    # 'class_names': ("Bed", "Bench", "Chair", "Dresser", "Microwave", "Oven", "Refrigerator", "Sofa", "Table")
